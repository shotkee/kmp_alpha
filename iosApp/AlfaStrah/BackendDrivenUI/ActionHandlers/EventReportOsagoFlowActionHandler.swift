//
//  EventReportOsagoFlowActionHandler.swift
//  AlfaStrah
//
...
extension BDUI {
	class EventReportOsagoFlowActionHandler: ActionHandler<EventReportOsagoFlowActionDTO>,
		...
		required init(
			block: EventReportOsagoFlowActionDTO
		) {
