//
//  ProlongationKindNeighborsFlowActionHandler.swift
//  AlfaStrah
//
...
extension BDUI {
	class ProlongationKindNeighborsFlowActionHandler: ActionHandler<ProlongationKindNeighborsFlowActionDTO>,
		...
		required init(
			block: ProlongationKindNeighborsFlowActionDTO
		) {
