//
//  ProlongationAlfaRepairFlowActionHandler.swift
//  AlfaStrah
//
...
extension BDUI {
	class ProlongationAlfaRepairFlowActionHandler: ActionHandler<ProlongationAlfaRepairFlowActionDTO>,
		...
		required init(
			block: ProlongationAlfaRepairFlowActionDTO
		) {
