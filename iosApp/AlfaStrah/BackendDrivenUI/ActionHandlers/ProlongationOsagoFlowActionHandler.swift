//
//  ProlongationOsagoFlowActionHandler.swift
//  AlfaStrah
//
...
extension BDUI {
	class ProlongationOsagoFlowActionHandler: ActionHandler<ProlongationOsagoFlowActionDTO>,
		...
		required init(
			block: ProlongationOsagoFlowActionDTO
		) {
