...
class CommonErrorInfoView: UIView, CommonNoteProtocol {
    struct Appearance {
        ...
        private enum Constants {
            static let defaultTitleStyle = Style.Label.subtext
            static let defaultNoteStyle = Style.Label.boldTitleBlack
            static let defaultErrorStyle = Style.Label.subtextRed
        }
    ...
    private func updateUI() {
        ...
        containerStackView.alpha = error == nil ? 0.5 : 1.0
    }
