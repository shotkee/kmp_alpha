...
class CardTableCell: UITableViewCell {
    static let id: Reusable<CardTableCell> = .fromClass()
    ...
    private func commonSetup() {
        ...
        imageArrowView.image = UIImage(named: "accessory-arrow")
        imageArrowView.tintColor = Style.Color.Palette.gray2
        ...
        NSLayoutConstraint.activate(
            NSLayoutConstraint.fill(view: cardView,
                                    in: contentView,
    ...
    func set(title: String, numberOfLinesForTitle: Int? = nil) {
        titleLabel.text = title
        if let numberOfLinesForTitle {
            titleLabel.numberOfLines = numberOfLinesForTitle
        }
    }
}
