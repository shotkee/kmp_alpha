...
struct MobileDeviceTokenRequestTransformer: Transformer {
    typealias Source = Any
    typealias Destination = MobileDeviceTokenRequest
    ...
    let operatingSystemTransformer = MobileDeviceTokenRequestOperatingSystemTransformer()
