...
struct CascanaChatThemeTransformer: Transformer {
    typealias Source = Any
    typealias Destination = CascanaChatTheme
    ...
    let childrenTransformer = ArrayTransformer(from: Any.self, transformer: CascanaChatChildThemeTransformer(), skipFailures: true)
