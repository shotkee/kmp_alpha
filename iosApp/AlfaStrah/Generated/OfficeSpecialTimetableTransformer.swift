...
struct OfficeSpecialTimetableTransformer: Transformer {
    typealias Source = Any
    typealias Destination = OfficeSpecialTimetable

    let dayName = "day"
    let isWorkingName = "is_working"
    let officeHoursName = "office_hours"

    let dayTransformer = DateTransformer<Any>(format: "yyyy-MM-dd", locale: AppLocale.currentLocale)
