...
#import "VIRTCCertificate.h"
#import "VIRTCCryptoOptions.h"
...
/**
 * If set to YES, enables WebRTC CPU Overuse Detection.
 * Default is YES.
 */
@property(nonatomic, assign) BOOL enableVideoCpuAdaptation;
